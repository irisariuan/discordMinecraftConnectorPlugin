...
/** Broadcasts a second-by-second countdown to all players. */
public class FabricCountdown {
    private final MinecraftServer server;
    private final ScheduledExecutorService scheduler;
    private ScheduledFuture<?> future;

    public FabricCountdown(MinecraftServer server, ScheduledExecutorService scheduler) {
        this.server = server;
